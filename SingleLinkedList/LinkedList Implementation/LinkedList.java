...
private class Node {
    ...
    linkedlist.LinkedListFull.Node next;
    linkedlist.LinkedListFull.Node head;
    ...
    public Node(Object dataValue, linkedlist.LinkedListFull.Node nextValue) {
        next = nextValue;
        data = dataValue;
    }
    ...
    public linkedlist.LinkedListFull.Node getNext() {
        return next;
    }

    public void setNext(linkedlist.LinkedListFull.Node nextValue) {
        next = nextValue;
    }
